...
class ModelTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.comment = Comment.objects.create(
            content="Test comment", feedback=self.feedback, author=self.admin_user
        )
...
class APITestCase(APITestCase):
    ...
    def setUp(self):
        ...
        # Create test boards
        self.public_board = Board.objects.create(
            name="Public Board", description="A public board", is_public=True
        )
        self.private_board = Board.objects.create(
            name="Private Board", description="A private board", is_public=False
        )
        self.private_board.members.add(self.contributor_user)
    ...
    def test_user_login(self):
        ...
        data = {"username": "contributor", "password": "testpass123"}
        response = self.client.post(url, data)
    ...
    def test_board_creation(self):
        ...
        url = reverse("board-list")
        data = {"name": "New Board", "description": "A new board", "is_public": True}
    ...
    def test_comment_creation(self):
        ...
        data = {"content": "This is a test comment", "feedback": self.feedback.id}
    ...
    def test_input_validation(self):
        ...
        # Test empty title
        data = {"title": "", "content": "Valid content", "board": self.public_board.id}
        response = self.client.post(url, data)
        self.assertEqual(response.status_code, status.HTTP_400_BAD_REQUEST)

        # Test empty content
        data = {"title": "Valid title", "content": "", "board": self.public_board.id}
        response = self.client.post(url, data)
        self.assertEqual(response.status_code, status.HTTP_400_BAD_REQUEST)
